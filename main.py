...
```
    print("MISTRAL:", r.status_code)

    if r.status_code == 200:
        return r.json()["choices"][0]["message"]["content"]

    raise Exception(f"MISTRAL {r.status_code}: {r.text}")
```
